    ...
    , m_series(nullptr)
{
    ...
    // Conexión: TempConverter → TempHistory
    QObject::connect(m_converter, &TempConverter::tempCelsiusChanged,
                     m_history,   &TempHistory::addTemperatureCelsius);

    // Conexión: TempHistory → MainWindow
    QObject::connect(m_history, &TempHistory::historyChanged,
...
void MainWindow::updateChart()
{
    ...
    for (int i = 0; i < n; ++i)
        m_series->append(i, m_history->valueAt(i));
